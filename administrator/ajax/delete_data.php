...
<form role="form" id="form_approve" action="admin_sql.php?type=delete_data&tb=admin&page=<?php echo $page; ?>&table=<?php echo $table ?>" method="post" enctype="multipart/form-data">
