...
$title = "Approve Order";
$message = "Are you sure you want to <strong>COMPLETE</strong> this Order?";
$button = "Yes! Complete It!";


?>
<form role="form" id="form" action="admin_sql.php?type=order_complete&tb=admin" method="post" enctype="multipart/form-data">
