            ...
            <tr style="border-collapse:collapse">
              <td align="center" style="padding:0;Margin:0">
                <table class="es-header-body" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#E6EBEF;width:600px">
                  <tr style="border-collapse:collapse">
                    <td align="left" bgcolor="#005f2a" style="padding:20px;Margin:0;background-color:#005F2A">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr style="border-collapse:collapse">
                                <td align="left" style="padding:0;Margin:0;padding-top:15px">
                                  ...
                                  <br><br>Your password to Caroma has just been reset. Please click on the link below to reset your password.
                                  <br><br><strong>Reset Link</strong> : <?php echo $path;?>
