                ...
                <div class="col-lg-12" style="padding-left:0px ; padding-right :0px ; padding-bottom : 20px">
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center product_btns">
                            <a data-toggle="modal" class="btn btn-primary btn-lg btn-block" href="#add_user"> &nbsp;Add User</a>
                ...
                <div class="modal inmodal" id="add_user" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content animated fadeIn">
                            <form role="form" id="form_user" action="user_register.php?type=user_register&tb=admin" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group"><label>Postcode</label> <input type="text" placeholder="Enter User Postcode" class="form-control" name="postcode" value=''></div>
                                    <div class="form-group"><label>City</label> <input type="text" placeholder="Enter User City" class="form-control" name="city" value=''></div>
