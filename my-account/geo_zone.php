            ...
            <div class="container-fluid">
                ...
                <div class="row heading-bg  bg-blue">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h5 class="txt-light"><?php echo $lang['lang-geo_zone']; ?></h5>
                    </div>
                </div>
                <!-- /Title -->
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h6 class="panel-title txt-dark"><?php echo $lang['lang-your_geo_zone']; ?></h6>
                                </div>
                                <div class="pull-right">
                                    <h6 class="panel-title txt-light">
                                        <i data-remote="ajax/geo_zone_add.php" data-toggle="modal" data-target=".bs-example-modal-lg" class="btn btn-success"><strong><?php echo $lang['lang-add_geo_zone']; ?></strong></i>
                                    </h6>
                                </div>
                            ...
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    <p class="text-muted"><?php echo $lang['lang-pls_check_your_geo']; ?></p>
                                                                        ...
                                                                        <table id="example" class="table table-hover display pb-30">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th><?php echo $lang['lang-description']; ?></th>
