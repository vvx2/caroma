$(function() {
    ...
    var error_distributor_code = false;
    ...
    function check_distributor_code() {
       ...
       if (pattern.test(distributor_code) && distributor_code !== '') {
          $("#distributor_code_error_message").hide();
          $("#distributor_code").css("border-bottom","2px solid #34F458");
       } else {
          $("#distributor_code_error_message").html("Must Enter A Valid Code");
          $("#distributor_code_error_message").show();
          $("#distributor_code").css("border-bottom","2px solid #F90A0A");
          error_distributor_code = true;
       }
    }
