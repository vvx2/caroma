...
<head>
    ...
    <title>Caroma Malaysia | Be inspired in our world of flavours and taste</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                        <a href="home-02.php" class="biolife-logo"><img src="assets/images/caroma-logo.png" alt="biolife logo" width="135" height="34"></a>
                    </div>
                            ...
                            <div class="minicart-block">
                                <div class="minicart-contain">
                                    <a href="javascript:void(0)" class="link-to">
                                        ...
                                        <span class="sub-total">$315.00</span>
                                    </a>
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
				...
				<li class="nav-item"><span class="current-page">News Details</span></li>
            </ul>
        </nav>
    </div>
    ...
    <div class="page-contain blog-page left-sidebar">
        <div class="container">
            <div class="row">
                ...
                <!-- Main content -->
                <div id="main-content" class="main-content col-lg-9 col-md-8 col-sm-12 col-xs-12 xs-margin-bottom-90px">
                    ...
                    <div class="single-post-contain">
                        ...
                        <div class="post-head">
                            ...
                            <p class="post-archive"><b class="post-cat">CAROMA</b><span class="post-date"> / 20 Nov, 2018</span><span class="author">Posted By: Caroma Malaysia</span></p>
                        </div>
